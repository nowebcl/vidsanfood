export const products = [
  {
    slug: "southern-king-crab",
    name_es: "Centolla Rey Chilena",
    name_en: "Southern King Crab",
    ...
    formats: [
      ...
      { es: "Entera Cocida Congelada", en: "Whole Cooked Frozen" },
      { es: "Carne Fancy", en: "Fancy Meat" }
    ],
    specs: {
      origin: "Patagonia Chile",
      packing: "IQF / Master Box",
      certification: "Sernapesca / HACCP"
    }
  },
  {
    slug: "sea-urchin",
    name_es: "Erizo de Mar",
    name_en: "Sea Urchin",
    ...
    formats: [
      ...
      { es: "Moldeado Congelado", en: "Frozen Molded" }
    ],
    specs: {
      quality: "Export Grade A",
      packing: "Plastic pots 100g / 200g"
    }
  },
  {
    slug: "chilean-abalone",
    name_es: "Loco (Abalón Chileno)",
    name_en: "Chilean Abalone (Loco)",
    ...
    formats: [
      ...
      { es: "Conservas Premium", en: "Premium Canned" }
    ],
    specs: {
      origin: "Northern / Central Chile",
      sizing: "Units per kg (various)"
    }
  },
  {
    slug: "juan-fernandez-lobster",
    name_es: "Langosta de Juan Fernández",
    name_en: "Juan Fernández Lobster",
    ...
    formats: [
      { es: "Entera Viva", en: "Whole Live" },
      { es: "Cola Congelada", en: "Frozen Tail" }
    ],
    specs: {
      origin: "Juan Fernández Archipelago",
      availability: "Seasonal capture"
    }
  },
  {
    slug: "patagonian-octopus",
    name_es: "Pulpo Patagónico",
    name_en: "Patagonian Octopus",
    ...
    formats: [
      ...
      { es: "Tentáculos IQF", en: "IQF Tentacles" }
    ],
    specs: {
      origin: "Southern Chile",
      sizing: "1kg to 4kg Masterbox"
    }
  },
  {
    slug: "chilean-mussels",
    name_es: "Choritos (Mejillones)",
    name_en: "Chilean Mussels",
    ...
    formats: [
      ...
      { es: "Carne IQF", en: "IQF Meat" }
    ],
    specs: {
      origin: "Chiloé Archipelago",
      packing: "Vacuum Packed / 5kg Bags"
    }
  },
  {
    ...
    formats: [
      ...
      { es: "Porciones IQF", en: "IQF Portions" }
    ],
    specs: {
      origin: "Puerto Montt / Aysén",
      presentation: "Skin on / Skin off"
    }
  },
  {
    slug: "marmola-crab",
    name_es: "Jaiba Mármola",
    name_en: "Marmola Crab",
    ...
    formats: [
      ...
      { es: "Pinzas de Jaiba", en: "Crab Claws" }
    ],
    specs: {
      origin: "Chilean South Coast",
      packing: "Masterbox 10kg"
    }
  }
]
